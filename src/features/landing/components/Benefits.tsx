export default function BenefitsRedesigned() {
  ...
  return (
    <section className="py-16 md:py-24 bg-gray-50 text-gray-900 relative overflow-hidden" id="benefits">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="flex flex-col space-y-6 md:space-y-8 max-w-5xl mx-auto">
