...
export default function Hero() {
  ...
  if (el) {
    const y = el.getBoundingClientRect().top + window.scrollY - 80; // 80px para navbar
      ...
      <div className="relative z-10 container mx-auto px-8 text-start space-y-4">
        <div className="max-w-4xl space-y-2">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white text-background leading-tight text-balance">
            Compite. Comparte.
            <br />
            <span>Conviertete en el mas fuerte.</span>
          </h1>
        ...
        <div className="flex gap-4">
          <button
            className="bg-blue-500 text-white font-semibold transform transition-transform duration-300 ease-out rounded-xl px-6 py-2 hover:-translate-y-1"
          ...
          <button
            className="bg-white text-black font-semibold transform transition-transform duration-300 ease-out rounded-xl px-6 py-2 hover:-translate-y-1"
